...
```bash
scripts/validate-artifact.rb <type> <file> [--schema-dir <dir>] [--tail <n>] [--expect-ids <id,...>] [--expect-cycle <cycle名>] [--since-last-cycle-start]
```
